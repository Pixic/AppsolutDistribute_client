...
{
    // static fields:
    private static final String VERSION = "Version 3.05";
    ...
    private void applyFilter(Filter filter)
    {
        if(currentImage != null) {
            ...
            frame.repaint();
            showStatus("Applied: " + filter.getClass().getName());
        }
        else {
    ...
    private List<Filter> createFilters()
    {
        ...
        filterList.add(new DarkerFilter());
        filterList.add(new LighterFilter());
        filterList.add(new ThresholdFilter());
        filterList.add(new FishEyeFilter());
    ...
    private void makeMenuBar(JFrame frame)
    {
        ...
        for(final Filter filter : filters) {
            item = new JMenuItem(filter.getClass().getName());
            item.addActionListener(new ActionListener() {
